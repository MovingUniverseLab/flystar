...
def write_transform(transform, starlist, reference, N_trans, deltaMag=0, restrict=False, weights=None,
    ...
    if trans_name == 'four_paramNW':
        ...
        raise TypeError(( '{0} not yet supported!'.format(trans_name)))
...
def generic_match(sl1, sl2, init_mode='triangle',
    ...
    if init_mode == 'triangle': #  Blind triangles method
        ...
        transf = initial_align(sl1_cut, sl2_cut, briteN=n_bright,
...
#                                                     verbose=verbose)
        ...
        transf, _ = find_transform(sl2_match[sl2_idx],
...
#                                         order=int(order_dr[i_loop][0]), verbose=verbose)
    ...
    sl2_idx, sl1_idx = transform_and_match(sl2, sl1, transf, dr_tol=dr_final,
                                                 verbose=verbose)
    #  StarTable output
